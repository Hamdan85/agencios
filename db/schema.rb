...
ActiveRecord::Schema[8.1].define(version: 20_260_701_200_000) do
  ...
  create_table 'account_metrics', force: :cascade do |t|
    ...
    t.index %w[social_account_id captured_at], name: 'index_account_metrics_on_social_account_id_and_captured_at'
    t.index ['social_account_id'], name: 'index_account_metrics_on_social_account_id'
    t.index %w[workspace_id captured_at], name: 'index_account_metrics_on_workspace_id_and_captured_at'
  end
  ...
  create_table 'admin_audit_logs', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[action created_at], name: 'index_admin_audit_logs_on_action_and_created_at'
    t.index ['staff_user_id'], name: 'index_admin_audit_logs_on_staff_user_id'
    t.index %w[target_type target_id], name: 'index_admin_audit_logs_on_target_type_and_target_id'
  end
  ...
  create_table 'ai_usage_logs', force: :cascade do |t|
    ...
    t.bigint 'user_id'
    t.bigint 'workspace_id', null: false
    t.index %w[operation created_at], name: 'index_ai_usage_logs_on_operation_and_created_at'
    t.index %w[provider created_at], name: 'index_ai_usage_logs_on_provider_and_created_at'
    t.index %w[subject_type subject_id], name: 'index_ai_usage_logs_on_subject_type_and_subject_id'
    t.index ['user_id'], name: 'index_ai_usage_logs_on_user_id'
    t.index %w[workspace_id created_at], name: 'index_ai_usage_logs_on_workspace_id_and_created_at'
  end
  ...
  create_table 'attachments', force: :cascade do |t|
    ...
    t.index %w[ticket_id position], name: 'index_attachments_on_ticket_id_and_position'
    t.index ['ticket_id'], name: 'index_attachments_on_ticket_id'
    t.index ['uploaded_by_id'], name: 'index_attachments_on_uploaded_by_id'
    t.index %w[workspace_id created_at], name: 'index_attachments_on_workspace_id_and_created_at'
  ...
  create_table 'charges', force: :cascade do |t|
    ...
    t.index ['mp_payment_id'], name: 'index_charges_on_mp_payment_id', unique: true,
  ...
  create_table 'clients', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'workspace_id', null: false
    t.index %w[workspace_id status], name: 'index_clients_on_workspace_id_and_status'
  ...
  create_table 'creatives', force: :cascade do |t|
    ...
    t.index %w[workspace_id status], name: 'index_creatives_on_workspace_id_and_status'
  ...
  create_table 'credit_transactions', force: :cascade do |t|
    ...
    t.index %w[kind created_at], name: 'index_credit_transactions_on_kind_and_created_at'
    t.index ['user_id'], name: 'index_credit_transactions_on_user_id'
    t.index %w[workspace_id created_at], name: 'index_credit_transactions_on_workspace_id_and_created_at'
  ...
  create_table 'generations', force: :cascade do |t|
    ...
    t.index %w[workspace_id kind status], name: 'index_generations_on_workspace_id_and_kind_and_status'
  ...
  create_table 'invoice_projects', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[invoice_id project_id], name: 'index_invoice_projects_on_invoice_id_and_project_id', unique: true
  ...
  create_table 'invoices', force: :cascade do |t|
    ...
    t.index ['external_reference'], name: 'index_invoices_on_external_reference', unique: true,
                                    where: '(external_reference IS NOT NULL)'
    t.index %w[workspace_id status], name: 'index_invoices_on_workspace_id_and_status'
  ...
  create_table 'mcp_call_logs', force: :cascade do |t|
    ...
    t.index %w[workspace_id created_at], name: 'index_mcp_call_logs_on_workspace_id_and_created_at'
  ...
  create_table 'meetings', force: :cascade do |t|
    ...
    t.index %w[workspace_id starts_at], name: 'index_meetings_on_workspace_id_and_starts_at'
  ...
  create_table 'memberships', force: :cascade do |t|
    ...
    t.index %w[workspace_id user_id], name: 'index_memberships_on_workspace_id_and_user_id', unique: true
  ...
  create_table 'notes', force: :cascade do |t|
    ...
    t.bigint 'user_id'
    t.bigint 'workspace_id', null: false
    t.index %w[ticket_id created_at], name: 'index_notes_on_ticket_id_and_created_at'
  ...
  create_table 'post_metrics', force: :cascade do |t|
    ...
    t.index %w[post_id captured_at], name: 'index_post_metrics_on_post_id_and_captured_at'
  ...
  create_table 'posts', force: :cascade do |t|
    ...
    t.index %w[workspace_id scheduled_at], name: 'index_posts_on_workspace_id_and_scheduled_at'
    t.index %w[workspace_id status], name: 'index_posts_on_workspace_id_and_status'
  ...
  create_table 'project_reports', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'workspace_id', null: false
    t.index %w[project_id created_at], name: 'index_project_reports_on_project_id_and_created_at'
    t.index ['project_id'], name: 'index_project_reports_on_project_id'
    t.index %w[workspace_id created_at], name: 'index_project_reports_on_workspace_id_and_created_at'
  end
  ...
  create_table 'projects', force: :cascade do |t|
    ...
    t.index %w[workspace_id status], name: 'index_projects_on_workspace_id_and_status'
  ...
  create_table 'social_accounts', force: :cascade do |t|
    ...
    t.string 'username'
    t.bigint 'workspace_id', null: false
    t.index %w[client_id provider], name: 'index_social_accounts_on_client_id_and_provider'
    t.index ['client_id'], name: 'index_social_accounts_on_client_id'
    t.index %w[workspace_id provider], name: 'index_social_accounts_on_workspace_id_and_provider'
  ...
  create_table 'strategy_sessions', force: :cascade do |t|
    ...
    t.bigint 'user_id'
    t.bigint 'workspace_id', null: false
    t.index %w[project_id status], name: 'index_strategy_sessions_on_project_id_and_status'
    t.index ['project_id'], name: 'index_strategy_sessions_on_project_id'
    t.index ['user_id'], name: 'index_strategy_sessions_on_user_id'
    t.index %w[workspace_id created_at], name: 'index_strategy_sessions_on_workspace_id_and_created_at'
  end
  ...
  create_table 'subtasks', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'workspace_id', null: false
    t.index %w[assignee_id done], name: 'index_subtasks_on_assignee_id_and_done'
  ...
  create_table 'ticket_relations', force: :cascade do |t|
    ...
    t.index %w[ticket_id related_ticket_id kind], name: 'index_ticket_relations_unique', unique: true
  ...
  create_table 'tickets', force: :cascade do |t|
    ...
    t.index %w[workspace_id scheduled_at], name: 'index_tickets_on_workspace_id_and_scheduled_at'
    t.index %w[workspace_id status position], name: 'index_tickets_on_workspace_id_and_status_and_position'
