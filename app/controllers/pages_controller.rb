  ...
  FEATURES = [
    {
      ...
      points: [
        { icon: "square-kanban", title: "Sete etapas coloridas", desc: "Ideação, Escopo, Produção, Agendado, Postado, Retrô e Concluído — cada uma com sua cor e seus campos." },
        { icon: "folder",        title: "Chips por projeto",     desc: "Cada card mostra o projeto e o cliente. Filtre por projeto, cliente, responsável, rede ou tipo de criativo." },
        { icon: "zap",           title: "Arrastar é uma ação",   desc: "Mover um card dispara a transição de status, registra o histórico e atualiza o resumo de IA — automaticamente." },
        { icon: "list-checks",   title: "Subtarefas e responsáveis", desc: "Quebre o trabalho em subtarefas atribuíveis que se agregam na tela 'Minhas tarefas' de cada pessoa." },
      ],
    ...
    },
    {
      ...
      points: [
        { icon: "sparkles",    title: "Resumo contextual",       desc: "Cada etapa do ticket ganha um resumo gerado pelo Claude que evolui junto com o conteúdo." },
        { icon: "lightbulb",   title: "Síntese de ideias",       desc: "O brief vira ângulos e ganchos concretos, prontos para virar escopo." },
        { icon: "list-checks", title: "Escopo automático",       desc: "Uma ideia vira um escopo com checklist de subtarefas, criado em segundos." },
        { icon: "chart-line",  title: "Retrospectiva automática", desc: "As métricas do post e o histórico viram uma retro com aprendizados para o próximo ciclo." },
      ],
    ...
    },
    {
      ...
      points: [
        { icon: "share-2",        title: "Todas as redes",  desc: "Instagram, Facebook, TikTok, YouTube, LinkedIn e X, com integração direta ou via agregador." },
        { icon: "calendar-clock", title: "Agendamento",     desc: "Programe a publicação no melhor horário e deixe o sistema publicar por você." },
        { icon: "bar-chart-3",    title: "Métricas por post", desc: "Alcance, visualizações, curtidas, comentários, compartilhamentos e salvamentos, sincronizados automaticamente." },
        { icon: "trending-up",    title: "Monitoramento",   desc: "Snapshots datados das métricas acompanham a evolução de cada conteúdo no ar." },
      ],
    ...
    },
    {
      ...
      points: [
        { icon: "calendar-days",  title: "Visão de mês e semana", desc: "Posts agendados e reuniões lado a lado, com arrastar-e-soltar para reagendar." },
        { icon: "users",          title: "Reuniões com o cliente", desc: "Crie reuniões no Google Calendar com link do Google Meet direto do app." },
        { icon: "calendar-clock", title: "Reagende arrastando",   desc: "Mude a data de um post ou reunião só arrastando o card no calendário." },
        { icon: "clock",          title: "Melhor horário",        desc: "Sugestões de melhor horário para publicar com base no histórico de performance." },
      ],
    ...
    },
    {
      ...
      points: [
        { icon: "receipt",      title: "Faturas por projeto",     desc: "Uma fatura pode cobrir um projeto, vários ou nenhum — com status claro do rascunho ao pago." },
        { icon: "zap",          title: "Pix em primeiro lugar",   desc: "Cobrança Pix com QR code, além de boleto e cartão, tudo via Mercado Pago." },
        { icon: "repeat",       title: "Conciliação automática",  desc: "Webhooks e uma varredura agendada confirmam o pagamento e atualizam o status sozinhos." },
        { icon: "shield-check", title: "Status confiável",        desc: "O pagamento só é dado como pago após a reconciliação direta com o Mercado Pago." },
      ],
